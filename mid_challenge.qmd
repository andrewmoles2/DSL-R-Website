...
Using data from the [HESA website](https://www.hesa.ac.uk/data-and-analysis/students){target='_blank'}, which has been prepared for you, replicate the output below. You will need to: 

- Make a new column with categories for LSE and Other universities  
- Calculate the average number of students per year per subject area and if the university is LSE or not
